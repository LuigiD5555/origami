...
origami-temporal-carrier, origami-candidate-build.
...
for d in cmd/ohf-lab cmd/ohf-glyphcalc cmd/origami-fixed-carrier cmd/origami-codec cmd/origami-profile3-carrier cmd/origami-automaton cmd/origami-temporal cmd/origami-temporal-carrier cmd/origami-candidate-build; do [[ -d "$ROOT/$d" ]] || die "$d missing"; done
...
for spec in 'ohf-lab ./cmd/ohf-lab' 'ohf-glyphcalc ./cmd/ohf-glyphcalc' 'origami-fixed-carrier ./cmd/origami-fixed-carrier' 'origami-codec ./cmd/origami-codec' 'origami-profile3-carrier ./cmd/origami-profile3-carrier' 'origami-automaton ./cmd/origami-automaton' 'origami-temporal ./cmd/origami-temporal' 'origami-temporal-carrier ./cmd/origami-temporal-carrier' 'origami-candidate-build ./cmd/origami-candidate-build'; do set -- $spec; go build -trimpath -o "$TMP_DIR/$1" "$2"; done
...
NAMES=(ohf-lab ohf-glyphcalc origami-fixed-carrier origami-codec origami-profile3-carrier origami-automaton origami-temporal origami-temporal-carrier origami-candidate-build)
