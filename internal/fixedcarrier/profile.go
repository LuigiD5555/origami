...
// It is intentionally independent from the size of the corpus behind Tlaloc.
type Profile struct {
	ID             string       `json:"id"`
...
var profileR2 = Profile{
	ID:            "origami.fixed-carrier.r2.profile-1",
	Width:         640,
	Height:        640,
	FixedPNGBytes: 8192,
	MaxPNGBytes:   512000,
	...
	Zones: []Zone{
		{ID: "T0", Purpose: "plaintext bootloader", X: 18, Y: 16, W: 604, H: 112},
		{ID: "T1", Purpose: "Rosetta and duplicated visual-presence challenge", X: 24, Y: 132, W: 592, H: 92},
		{ID: "T2", Purpose: "root index and graph navigation", X: 18, Y: 228, W: 604, H: 64},
		{ID: "T3", Purpose: "dense machine control record and visual state map", X: 18, Y: 296, W: 604, H: 252},
		{ID: "VERIFY", Purpose: "duplicated challenge and verification footer", X: 24, Y: 552, W: 592, H: 72},
	},
	FamilyBindings: []FamilyBind{
		{Family: "F01", Role: "node/tool kind", Zone: "T2/T3", Status: "navigation_core_candidate"},
		...
		{Family: "F21", Role: "adjacency", Zone: "T2", Status: "navigation_core_candidate"},
		...
		{Family: "F40", Role: "macro region", Zone: "T2", Status: "navigation_core_candidate"},
